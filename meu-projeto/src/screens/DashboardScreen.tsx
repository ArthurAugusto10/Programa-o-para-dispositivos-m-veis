      ...
      <View style={styles.menuGrid}>
        ...
        {perfilUsuario === 'Adm' && (
          <>
            ...
            <MenuCard title="Matricular Aluno a uma matéria" icon="link-variant" screen="MatricularAluno" />
            ...
            {/* 🎓 NOVO REQUISITO: Módulo de Cursos (Listagem + CRUD via Modal) */}
            <MenuCard title="Gerenciar Cursos" icon="certificate" screen="GerenciarCursos" />
          </>
        )}
